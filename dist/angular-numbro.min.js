 ...
 */
"use strict";angular.module("ngNumbro",[]).provider("$numbroConfig",function(){var a={};this.setFormat=function(b,c){a[b]=c},this.setDefaultFormat=function(a){numbro.defaultFormat(a)},this.setLanguage=function(a,b){numbro.language(a,b)},this.setCurrentLanguage=function(a){numbro.language(a)},this.$get=function(){return{customFormat:function(b){return a[b]||b}}}}).filter("numbro",["$numbroConfig",function(a){return function(b,c){return null==b?b:(c=a.customFormat(c),numbro(b).format(c))}}]);